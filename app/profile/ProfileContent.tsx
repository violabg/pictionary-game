...
export function ProfileContent({ profile }: { profile: ProfileData }) {
  return (
    <div className="flex flex-col justify-center items-center min-h-[60vh]">
      <Card className="bg-gradient-to-br from-[oklch(0.98_0.01_220)] dark:from-[oklch(0.25_0.02_220)] to-[oklch(0.85_0.04_270)] dark:to-[oklch(0.45_0.04_270)] border border-gradient w-full max-w-md">
